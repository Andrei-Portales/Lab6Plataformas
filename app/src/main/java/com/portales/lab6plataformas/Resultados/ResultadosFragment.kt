...
import com.portales.lab6plataformas.databinding.FragmentResultBinding
...
class ResultadosFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, viewModelFactory).get(ResultadosViewModel::class.java)
